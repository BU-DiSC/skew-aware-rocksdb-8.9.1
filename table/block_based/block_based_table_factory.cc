    ...
    block_based_table_type_info = {
        ...
        {"checksum",
         {offsetof(struct BlockBasedTableOptions, checksum),
          ...
          OptionTypeFlags::kNone}},
        {"bits_per_key_alloc_type",
         {offsetof(struct BlockBasedTableOptions, bpk_alloc_type),
          OptionType::kBitsPerKeyAllocationType,
          OptionVerificationType::kNormal, OptionTypeFlags::kNone}},
        {"modular_filters",
         {offsetof(struct BlockBasedTableOptions, modular_filters),
          OptionType::kBoolean,
          OptionVerificationType::kNormal, OptionTypeFlags::kNone}},
        {"max_bits_per_key_granularity",
         {offsetof(struct BlockBasedTableOptions, max_bits_per_key_granularity),
          OptionType::kDouble,
          OptionVerificationType::kNormal, OptionTypeFlags::kNone}},
        {"max_modulars",
         {offsetof(struct BlockBasedTableOptions, max_modulars),
          OptionType::kSizeT,
          OptionVerificationType::kNormal, OptionTypeFlags::kNone}},
